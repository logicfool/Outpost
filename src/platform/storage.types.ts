import type { BackupStore as importBackupStore } from '../core/backup';
import type { MatchArchiveStore } from '../core/matchArchive';
...
export interface Repository extends importAimStore, MatchArchiveStore, importBackupStore {
